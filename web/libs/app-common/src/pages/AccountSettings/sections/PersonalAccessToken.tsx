        ...
        <div>
          ...
          <div className="flex gap-2 w-full justify-between">
            ...
            <Button
              ...
              className="w-[116px]"
            >
              {tokenCopied ? t("accountSettings.personalAccessToken.copied") : t("accountSettings.personalAccessToken.copy")}
            </Button>
            <Button variant="negative" look="outlined" onClick={() => reset.mutate()}>
              {t("accountSettings.personalAccessToken.reset")}
            </Button>
          </div>
        </div>
        <div>
          <Label text={t("accountSettings.personalAccessToken.exampleCurl")} className={styles.label} />
          <div className="flex gap-2 w-full justify-between">
            <TextArea
              name="example-curl"
              readOnly
            ...
            <Button
              ...
              className="w-[116px]"
            >
              {curlCopied ? t("accountSettings.personalAccessToken.copied") : t("accountSettings.personalAccessToken.copy")}
            </Button>
          </div>
        </div>
      </div>
...
export function PersonalAccessTokenDescription() {
  ...
  return (
    <Typography>
      {t("accountSettings.personalAccessToken.description")}
      {!window.APP_SETTINGS?.whitelabel_is_active && (
        <>
          {" "}
          {t("accountSettings.personalAccessToken.see")} {" "}
          <a href="https://labelstud.io/guide/api.html" target="_blank" rel="noreferrer" className="inline-flex gap-1">
            {t("accountSettings.personalAccessToken.docs")}{" "}
            <span>
