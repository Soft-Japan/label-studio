      ...
      <div className="py-3 space-y-3 border-b border-border last:border-0">
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            aria-label={t("accountSettings.hotkeys.clickToRecord")}
          >
            {keyRecordingMode ? (
              <span className="text-primary-content font-medium animate-pulse">{t("accountSettings.hotkeys.pressKeysNow")}</span>
            ) : editedKey ? (
              <KeyboardKey>{editedKey}</KeyboardKey>
            ) : (
              <span className="text-neutral-content-subtler">{t("accountSettings.hotkeys.clickToSetShortcut")}</span>
            )}
          </Button>
          ...
          <div className="flex flex-row gap-2">
            <Button variant="primary" onClick={handleSave} disabled={!editedKey || !!error}>
              {t("accountSettings.hotkeys.apply")}
            </Button>
    ...
    >
      ...
      <div className="flex-none mr-4">
        <UiToggle
          ...
          aria-label={`${hotkey.active ? t("accountSettings.hotkeys.disable") : t("accountSettings.hotkeys.enable")} ${hotkey.label}`}
        />
      </div>
      ...
      <Tooltip title={t("accountSettings.hotkeys.clickToEditHotkey")}>
        <div
