...
export const DensityToggle = densityInjector(
  observer(({ size, onChange, storageKey, view, ...rest }: DensityToggleProps) => {
    ...
    return (
      ...
      >
        <Tooltip title={t("datamanager.toolbar.density.comfortable", "Comfortable density")}>
          <div>
            <RadioGroup.Button
              value={DENSITY_COMFORTABLE}
              aria-label={t("datamanager.toolbar.density.comfortable", "Comfortable density")}
        ...
        <Tooltip title={t("datamanager.toolbar.density.compact", "Compact density")}>
          <div>
            <RadioGroup.Button
              value={DENSITY_COMPACT}
              aria-label={t("datamanager.toolbar.density.compact", "Compact density")}
